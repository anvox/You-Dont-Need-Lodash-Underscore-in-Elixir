# [You don't (may not) need Lodash/Underscore in ELixir](https://github.com/anvox/You-Dont-Need-Lodash-Underscore-in-Elixir)


Forked from [You-Dont-Need-Lodash-Underscore](https://github.com/you-dont-need/You-Dont-Need-Lodash-Underscore), just having fun in practicing Elixir. I may package them into a package, `Elixir-Lodash` I guess, but who need it 😆 ?
